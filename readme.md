...
### To generate the random image

> https://picsum.photos/id/237/200/300    (spefic image types with id, 237 is an id)

> https://picsum.photos/200/300

> https://picsum.photos/500   (square iamges)
...
> https://picsum.photos/200/300/?blur=2   (limit 10)

> https://picsum.photos/id/870/200/300?grayscale&blur=2


**How you can use the images in your HTML code**
...
> https://picsum.photos/200/300.jpg (you need a jpg file)

> https://picsum.photos/200/300.webp (webp format image file)

> https://picsum.photos/v2/list (list of images)

> https://picsum.photos/id/0/info (image details)

> https://picsum.photos/seed/picsum/info (image details)
...
3. At this point, you have renamed the local branch. If you’ve already pushed the <old_name> branch to the remote
   repository, perform the next steps to rename the remote branch.
